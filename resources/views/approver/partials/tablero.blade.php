<div class="row">
    ...
    <!--Vales Ingresados -->
    <div onclick="dirigeme('enlacesolicitudesvale')" class="col-lg-4 col-md-6">
            ...
            <div class="panel-heading" style="background-color:#66cd00; color: #fff ">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Solicitudes Vale Consumo</div>
                    </div>
                </div>
            </div>
            <a id="enlacesolicitudesvale" href="{{route("approver.approver.index")}}">
                <div class="panel-footer">
                    <span class="pull-left">Ingresar</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
